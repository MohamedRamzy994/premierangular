...
var PrintbuybackwithbillComponent = /** @class */ (function () {
    function PrintbuybackwithbillComponent(_activatedRoute, _listproductbuydiscardmaininvoicesService, _listproductbuydiscardmaininvoiceitemsService, _router) {
    ...
    PrintbuybackwithbillComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PrintbuybackwithbillComponent.prototype.getProductBuyDiscardMainInvoiceItems = function () {
        var _this = this;
    ...
    PrintbuybackwithbillComponent.prototype.getproductbuydiscardSlelectedInvoice = function () {
        var _this = this;
    ...
    PrintbuybackwithbillComponent.prototype.PrintReportInvoice = function () {
    ...
    PrintbuybackwithbillComponent = __decorate([
        core_1.Component({
            selector: 'app-printbuybackwithbill',
            templateUrl: './printbuybackwithbill.component.html',
            styleUrls: ['./printbuybackwithbill.component.css']
        }),
    ...
    return PrintbuybackwithbillComponent;
}());
exports.PrintbuybackwithbillComponent = PrintbuybackwithbillComponent;
//# sourceMappingURL=printbuybackwithbill.component.js.map