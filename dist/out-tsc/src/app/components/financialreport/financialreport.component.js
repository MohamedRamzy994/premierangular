...
// tslint:disable-next-line:max-line-length
var listsystemcreatetotainformationmoneyreport_service_1 = require("src/app/services/reports/listsystemcreatetotainformationmoneyreport.service");
var FinancialreportComponent = /** @class */ (function () {
    function FinancialreportComponent(_listsystemcreatetotainformationmoneyreportService, _listsalespointsService) {
        this._listsystemcreatetotainformationmoneyreportService = _listsystemcreatetotainformationmoneyreportService;
        this._listsalespointsService = _listsalespointsService;
        this.myOptions = {
            dateFormat: 'mmm d, yyyy',
        };
        this.listGetStartBalanceModel = new reports_1.SystemCreateTotalInformationMoneyReport();
    ...
    FinancialreportComponent.prototype.GetDateFrom = function (event) {
        this.DateFrom = this.DateFromObject.jsdate;
    };
    FinancialreportComponent.prototype.GetDateTo = function (event) {
        this.DateTo = this.DateToObject.jsdate;
    };
    /**
     * GetStartBalance
     */
    FinancialreportComponent.prototype.GetStartBalance = function () {
        var _this = this;
        this._listsystemcreatetotainformationmoneyreportService.CreateTotalInformationMoneyReport()
            .subscribe(function (_result) {
            console.log(_result);
            _this.listGetStartBalanceModel = _result.SystemCreateTotalInformationMoneyReport[0];
        });
    };
    FinancialreportComponent.prototype.GetAllSalesPoints = function () {
        var _this = this;
    ...
    FinancialreportComponent.prototype.PrintSupplierMoneyDetails = function () {
    ...
    FinancialreportComponent = __decorate([
        ...
        __metadata("design:paramtypes", [listsystemcreatetotainformationmoneyreport_service_1.ListsystemcreatetotainformationmoneyreportService,
...
//# sourceMappingURL=financialreport.component.js.map