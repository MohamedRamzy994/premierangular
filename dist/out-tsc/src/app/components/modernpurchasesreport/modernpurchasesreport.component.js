...
var ModernpurchasesreportComponent = /** @class */ (function () {
    function ModernpurchasesreportComponent(_listsuppliersService, _listgroupsService, _liststoresService, _listproductbuymaininvoicesService, _listproducttotalcommunicationreportService) {
    ...
    ModernpurchasesreportComponent.prototype.ngOnInit = function () {
        this.getAllSuppliers();
        this.ListProductInventoryReport(this.supplierID);
    };
    ModernpurchasesreportComponent.prototype.getAllSuppliers = function () {
        var _this = this;
    ...
    ModernpurchasesreportComponent.prototype.GetDateFrom = function (event) {
        this.DateFrom = this.DateFromObject.jsdate;
    };
    ModernpurchasesreportComponent.prototype.GetDateTo = function (event) {
        this.DateTo = this.DateToObject.jsdate;
    };
    ModernpurchasesreportComponent.prototype.ListProductInventoryReport = function (_supplierID) {
        var _this = this;
        this._listproductbuymaininvoicesService.listProductBuyMainInvoices()
            ...
            if (_result.ProductBuyInvoices === null) {
                ...
                if (_this.supplierID === 0) {
                    _this.listProductMoveMentReportModel = _result.ProductBuyInvoices;
                    _this.productBuySelectTotalCommunicationReportModel = { BuyNumber: 0, DiscardNumber: 0, BuyPrice: 0, BuyQuntity: 0, DiscardPrice: 0, DiscardQuantity: 0 };
                }
                else {
                    _this._listsuppliersService.ListSuppliers().subscribe(function (_resultsupp) {
                        _this.supplierName = _resultsupp.SuppliersList.filter(function (value) { return value.SupplierID == _supplierID; })[0].SupplierName;
                        _this.listProductMoveMentReportModel = _result.ProductBuyInvoices.filter(function (value) { return value.SupplierName === _this.supplierName; });
                    });
                }
            }
        });
    ...
    ModernpurchasesreportComponent.prototype.ListProductTotalCommunicationReport = function (_supplierID) {
        var _this = this;
    ...
    ModernpurchasesreportComponent.prototype.SelectRow = function (_invoicemain) {
        this.SelectedProductSaleMainInvoice = _invoicemain;
    };
    ModernpurchasesreportComponent.prototype.RowSelected = function (_invoicemain) {
    ...
    ModernpurchasesreportComponent.prototype.RemoveSelection = function (_invoicemain) {
        this.SelectedProductSaleMainInvoice = new reports_1.ListSupplierProductsInStoreModel();
    };
    ModernpurchasesreportComponent.prototype.PrintSupplierMoneyDetails = function () {
    ...
    ModernpurchasesreportComponent = __decorate([
        core_1.Component({
            selector: 'app-modernpurchasesreport',
            templateUrl: './modernpurchasesreport.component.html',
            styleUrls: ['./modernpurchasesreport.component.css']
        }),
    ...
    return ModernpurchasesreportComponent;
}());
exports.ModernpurchasesreportComponent = ModernpurchasesreportComponent;
//# sourceMappingURL=modernpurchasesreport.component.js.map