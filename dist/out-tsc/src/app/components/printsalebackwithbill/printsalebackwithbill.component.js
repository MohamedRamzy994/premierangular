...
var listproductsalediscardmaininvoiceitems_service_1 = require("src/app/services/productsales/listproductsalediscardmaininvoiceitems.service");
var printd_1 = require("printd");
var PrintsalebackwithbillComponent = /** @class */ (function () {
    function PrintsalebackwithbillComponent(_activatedRoute, _router, _listproductsalediscardmaininvoicesService, _listproductsalediscardmaininvoiceitemsService) {
        this._activatedRoute = _activatedRoute;
        this._router = _router;
        this._listproductsalediscardmaininvoicesService = _listproductsalediscardmaininvoicesService;
        this._listproductsalediscardmaininvoiceitemsService = _listproductsalediscardmaininvoiceitemsService;
    ...
    PrintsalebackwithbillComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PrintsalebackwithbillComponent.prototype.getProductSaleDiscardMainInvoiceItems = function () {
        var _this = this;
    ...
    PrintsalebackwithbillComponent.prototype.getproductsalediscardSlelectedInvoice = function () {
        var _this = this;
    ...
    PrintsalebackwithbillComponent.prototype.PrintReportInvoice = function () {
    ...
    PrintsalebackwithbillComponent = __decorate([
        core_1.Component({
            selector: 'app-printsalebackwithbill',
            templateUrl: './printsalebackwithbill.component.html',
            styleUrls: ['./printsalebackwithbill.component.css']
        }),
        __metadata("design:paramtypes", [router_1.ActivatedRoute,
            router_1.Router,
            listproductsalediscardmaininvoices_service_1.ListproductsalediscardmaininvoicesService,
            listproductsalediscardmaininvoiceitems_service_1.ListproductsalediscardmaininvoiceitemsService])
    ], PrintsalebackwithbillComponent);
    return PrintsalebackwithbillComponent;
}());
exports.PrintsalebackwithbillComponent = PrintsalebackwithbillComponent;
//# sourceMappingURL=printsalebackwithbill.component.js.map