...
var SalesreportdelegatesComponent = /** @class */ (function () {
    function SalesreportdelegatesComponent(_listcustomersService, _listgroupsService, _liststoresService, _listproductbuymaininvoicesService, _listproductsaleselectmaininvoicestoreportService, _listemployeetotalcommunicationreportService) {
    ...
    SalesreportdelegatesComponent.prototype.ngOnInit = function () {
        this.getAllEmployees();
        // this.ListProductInventoryReport(this.supplierID);
        this.getAllProductSaleMainInvoices(this.employeeID);
    };
    SalesreportdelegatesComponent.prototype.getAllProductSaleMainInvoices = function (_employeeID) {
        var _this = this;
        this._listproductsaleselectmaininvoicestoreportService.CustomerMainInvoicesSalesReportDelegates()
            ...
            if (_result.ListProductSaleSelectMainInvoicesToReport === null) {
                ...
                if (_employeeID === 0) {
                    _this.AllProductSaleMainInvoices = _result.ListProductSaleSelectMainInvoicesToReport;
                    ...
                    _this._listcustomersService.ListEmployees().subscribe(function (_resultemp) {
                        _this.supplierName =
                            _resultemp.EmployeesList.filter(function (value) { return value.EmpID == _employeeID; })[0].EmpName;
                        _this.AllProductSaleMainInvoices =
                            _result.ListProductSaleSelectMainInvoicesToReport
                                .filter(function (value) { return value.EmpID == _this.employeeID; });
                        _this.AllProductSaleMainInvoices.forEach(function (element) {
                            if (element.InvTypeID === 1) {
                                element.InvTypeName = 'نقدى';
                            }
    ...
    SalesreportdelegatesComponent.prototype.getAllEmployees = function () {
        var _this = this;
    ...
    SalesreportdelegatesComponent.prototype.GetDateFrom = function (event) {
        this.DateFrom = this.DateFromObject.jsdate;
    };
    SalesreportdelegatesComponent.prototype.GetDateTo = function (event) {
        this.DateTo = this.DateToObject.jsdate;
    };
    ...
    // }
    SalesreportdelegatesComponent.prototype.ListProductTotalCommunicationReport = function (_supplierID) {
        var _this = this;
    ...
    SalesreportdelegatesComponent.prototype.SelectRow = function (_invoicemain) {
        this.SelectedProductSaleMainInvoice = _invoicemain;
    };
    SalesreportdelegatesComponent.prototype.RowSelected = function (_invoicemain) {
    ...
    SalesreportdelegatesComponent.prototype.RemoveSelection = function (_invoicemain) {
        this.SelectedProductSaleMainInvoice = new reports_1.ListSupplierProductsInStoreModel();
    };
    SalesreportdelegatesComponent.prototype.PrintSupplierMoneyDetails = function () {
    ...
    SalesreportdelegatesComponent = __decorate([
        core_1.Component({
    ...
    return SalesreportdelegatesComponent;
}());
exports.SalesreportdelegatesComponent = SalesreportdelegatesComponent;
//# sourceMappingURL=salesreportdelegates.component.js.map