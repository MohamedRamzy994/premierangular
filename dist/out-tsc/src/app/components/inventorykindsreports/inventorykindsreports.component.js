...
var listproductsupplierinstorereport_service_1 = require("src/app/services/reports/listproductsupplierinstorereport.service");
var InventorykindsreportsComponent = /** @class */ (function () {
    function InventorykindsreportsComponent(_listgroupsService, _liststoresService, _listsuppliersService, _listproductsupplierinstorereportService) {
        ...
        this._listproductsupplierinstorereportService = _listproductsupplierinstorereportService;
        this.myOptions = {
            // other options...
    ...
    InventorykindsreportsComponent.prototype.ngOnInit = function () {
        this.GetAllGroups();
        this.getAllStores();
        this.getAllSuppliers();
        this.ListProductInventoryReport(this.storeID);
    };
    InventorykindsreportsComponent.prototype.GetAllGroups = function () {
        var _this = this;
    ...
    InventorykindsreportsComponent.prototype.getAllStores = function () {
        var _this = this;
        this._liststoresService.listStores().subscribe(function (_result) {
            _this.result = _result;
            if (_result.StoresList === null) {
                _this.result.StoresList = [];
            }
            else {
                _this.result.StoresList = _result.StoresList;
            }
        });
    };
    InventorykindsreportsComponent.prototype.getAllSuppliers = function () {
        var _this = this;
    ...
    InventorykindsreportsComponent.prototype.GetDateFrom = function (event) {
        this.DateFrom = this.DateFromObject.jsdate;
    };
    InventorykindsreportsComponent.prototype.GetDateTo = function (event) {
        this.DateTo = this.DateToObject.jsdate;
    };
    InventorykindsreportsComponent.prototype.ListProductInventoryReport = function (_storeID) {
        var _this = this;
        this._listproductsupplierinstorereportService.ListProductSupplierInStoreReport(_storeID)
            ...
            if (_result.ListSupplierProductsInStoreModel === null) {
                ...
                if (_this.supplierID === 0) {
                    _this.listProductMoveMentReportModel = _result.ListSupplierProductsInStoreModel;
                    console.log(_this.listProductMoveMentReportModel);
                }
                else {
                    _this.listProductMoveMentReportModel = _result.ListSupplierProductsInStoreModel
                        .filter(function (item) { return item.SupplierID === _this.supplierID; });
                }
            }
        });
    };
    InventorykindsreportsComponent.prototype.SelectRow = function (_invoicemain) {
        this.SelectedProductSaleMainInvoice = _invoicemain;
    };
    InventorykindsreportsComponent.prototype.RowSelected = function (_invoicemain) {
    ...
    InventorykindsreportsComponent.prototype.RemoveSelection = function (_invoicemain) {
        this.SelectedProductSaleMainInvoice = new reports_1.ListSupplierProductsInStoreModel();
    };
    InventorykindsreportsComponent.prototype.PrintSupplierMoneyDetails = function () {
    ...
    InventorykindsreportsComponent = __decorate([
        core_1.Component({
        ...
        __metadata("design:paramtypes", [listgroups_service_1.ListgroupsService,
            ...
            listproductsupplierinstorereport_service_1.ListproductsupplierinstorereportService])
    ], InventorykindsreportsComponent);
    return InventorykindsreportsComponent;
}());
exports.InventorykindsreportsComponent = InventorykindsreportsComponent;
//# sourceMappingURL=inventorykindsreports.component.js.map