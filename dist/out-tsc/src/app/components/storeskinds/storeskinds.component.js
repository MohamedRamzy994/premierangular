...
var StoreskindsComponent = /** @class */ (function () {
    function StoreskindsComponent(_oauthenticatedsessionService) {
        this._oauthenticatedsessionService = _oauthenticatedsessionService;
    }
    StoreskindsComponent.prototype.ngOnInit = function () {
        this.getLoggedUser();
    };
    /**
    * getLoggedUser
    */
    StoreskindsComponent.prototype.getLoggedUser = function () {
        this.authenticatedUser = this._oauthenticatedsessionService.User;
    };
    StoreskindsComponent = __decorate([
        core_1.Component({
    ...
    return StoreskindsComponent;
}());
exports.StoreskindsComponent = StoreskindsComponent;
//# sourceMappingURL=storeskinds.component.js.map