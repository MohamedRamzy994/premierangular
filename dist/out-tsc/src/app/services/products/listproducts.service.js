...
var ListproductsService = /** @class */ (function () {
    function ListproductsService(_apiurlService, http, _logservice) {
        this._apiurlService = _apiurlService;
        this.http = http;
        this._logservice = _logservice;
    }
    ListproductsService.prototype.listproducts = function () {
        this.listproductapiurl = this._apiurlService.apiUrl.concat('/api/ProductsApi/GetAllProducts');
        return this.http.get(this.listproductapiurl, httpOptions).
            pipe(operators_1.catchError(this.handleError('ListproductsService')));
    };
    // TODO : log messages to console
    ListproductsService.prototype.log = function (message) {
        this._logservice.add("ListproductsService: " + message);
    };
    ListproductsService.prototype.handleError = function (operation, result) {
        var _this = this;
