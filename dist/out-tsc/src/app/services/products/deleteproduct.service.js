...
var DeleteproductService = /** @class */ (function () {
    function DeleteproductService(_apiurlService, http, _logservice) {
        this._apiurlService = _apiurlService;
        this.http = http;
        this._logservice = _logservice;
    }
    DeleteproductService.prototype.DeleteProduct = function (_productbasic) {
        this.deleteproductapiurl = this._apiurlService.apiUrl.concat('/api/ProductsApi/DeleteProduct');
        return this.http.post(this.deleteproductapiurl, _productbasic, httpOptions).
            pipe(operators_1.catchError(this.handleError('DeleteproductService')));
    };
    // TODO : log messages to console
    DeleteproductService.prototype.log = function (message) {
        this._logservice.add("DeleteproductService: " + message);
    };
    DeleteproductService.prototype.handleError = function (operation, result) {
        var _this = this;
