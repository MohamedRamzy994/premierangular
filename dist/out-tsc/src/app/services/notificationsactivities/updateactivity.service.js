...
var UpdateactivityService = /** @class */ (function () {
    function UpdateactivityService(_apiurlService, http, _logservice) {
        this._apiurlService = _apiurlService;
        this.http = http;
        this._logservice = _logservice;
    }
    UpdateactivityService.prototype.UpdateActivityRecord = function (ID, Read) {
        ...
        return this.http.post(this.addstoreapiurl, httpOptions).
            pipe(operators_1.catchError(this.handleError('UpdateactivityService')));
    };
    // TODO : log messages to console
    UpdateactivityService.prototype.log = function (message) {
        this._logservice.add("UpdateactivityService: " + message);
    };
    UpdateactivityService.prototype.handleError = function (operation, result) {
        var _this = this;
...
//# sourceMappingURL=updateactivity.service.js.map