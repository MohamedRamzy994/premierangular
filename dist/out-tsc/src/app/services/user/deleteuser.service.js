...
var DeleteuserService = /** @class */ (function () {
    function DeleteuserService(http, _apiurl, _logservice) {
        this.http = http;
        this._apiurl = _apiurl;
        this._logservice = _logservice;
    }
    DeleteuserService.prototype.deleteUser = function (_user) {
        this.deleteuserurl = this._apiurl.apiUrl.concat('/api/UserApi/DeleteUser');
        return this.http.put(this.deleteuserurl, _user, httpOptions)
            .pipe(operators_1.catchError(this.handleError('deleteuser')));
    };
    // TODO : log messages to console
    DeleteuserService.prototype.log = function (message) {
        this._logservice.add("DeleteuserService: " + message);
    };
    DeleteuserService.prototype.handleError = function (operation, result) {
        var _this = this;
