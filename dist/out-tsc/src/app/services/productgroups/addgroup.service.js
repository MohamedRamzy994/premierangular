...
var AddgroupService = /** @class */ (function () {
    function AddgroupService(_apiurlService, http, _logservice) {
        this._apiurlService = _apiurlService;
        this.http = http;
        this._logservice = _logservice;
    }
    AddgroupService.prototype.AddGroup = function (_group) {
        this.addgroupapiurl = this._apiurlService.apiUrl.concat('/api/ProductGroupsApi/AddGroup');
        return this.http.post(this.addgroupapiurl, _group, httpOptions).
            pipe(operators_1.catchError(this.handleError('AddGroup')));
    };
    // TODO : log messages to console
    AddgroupService.prototype.log = function (message) {
        this._logservice.add("AddGroupService: " + message);
    };
    AddgroupService.prototype.handleError = function (operation, result) {
        var _this = this;
...
//# sourceMappingURL=addgroup.service.js.map