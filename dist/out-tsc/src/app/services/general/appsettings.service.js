...
var AppsettingsService = /** @class */ (function () {
    function AppsettingsService(_apiurlService, http, _logservice) {
    ...
    AppsettingsService.prototype.AppSettings = function () {
        return this.http.get(this.oauthapiurl, httpOptions)
            .pipe(operators_1.catchError(this.handleError('AppsettingsService')));
    };
    // TODO : log messages to console
    AppsettingsService.prototype.log = function (message) {
