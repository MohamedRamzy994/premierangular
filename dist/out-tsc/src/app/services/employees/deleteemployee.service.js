...
var DeleteemployeeService = /** @class */ (function () {
    function DeleteemployeeService(_apiurlService, http, _logservice) {
        this._apiurlService = _apiurlService;
        this.http = http;
        this._logservice = _logservice;
    }
    DeleteemployeeService.prototype.DeleteEmployee = function (_supplier) {
        this.deleteemployeeapiurl = this._apiurlService.apiUrl.concat('/api/EmployeesApi/DeleteEmployee');
        return this.http.post(this.deleteemployeeapiurl, _supplier, httpOptions).
            pipe(operators_1.catchError(this.handleError('DeleteemployeeService')));
    };
    // TODO : log messages to console
    DeleteemployeeService.prototype.log = function (message) {
        this._logservice.add("DeleteemployeeService: " + message);
    };
    DeleteemployeeService.prototype.handleError = function (operation, result) {
        var _this = this;
    ...
    DeleteemployeeService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        }),
