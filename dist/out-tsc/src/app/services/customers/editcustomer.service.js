...
var EditcustomerService = /** @class */ (function () {
    function EditcustomerService(_apiurlService, http, _logservice) {
        this._apiurlService = _apiurlService;
        this.http = http;
        this._logservice = _logservice;
    }
    EditcustomerService.prototype.EditCustomer = function (_customer) {
        this.editcustomerapiurl = this._apiurlService.apiUrl.concat('/api/CustomersApi/EditCustomer');
        return this.http.post(this.editcustomerapiurl, _customer, httpOptions).
            pipe(operators_1.catchError(this.handleError('EditcustomerService')));
    };
    // TODO : log messages to console
    EditcustomerService.prototype.log = function (message) {
        this._logservice.add("EditcustomerService: " + message);
    };
    EditcustomerService.prototype.handleError = function (operation, result) {
        var _this = this;
    ...
    EditcustomerService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        }),
