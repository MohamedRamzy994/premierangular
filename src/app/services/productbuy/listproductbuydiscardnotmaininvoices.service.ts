...
export class ListproductbuydiscardnotmaininvoicesService {
  private listproductdiscardnotmaininvoicesapiurl: string;
  ...
  listProductBuyDiscardMainInvoices(): Observable<ResultProductBuyDiscardSelectMainInvoices> {
    ...
    return this.http.get<ResultProductBuyDiscardSelectMainInvoices>(this.listproductdiscardnotmaininvoicesapiurl, httpOptions
    ).pipe(
