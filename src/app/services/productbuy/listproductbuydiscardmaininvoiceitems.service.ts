...
export class ListproductbuydiscardmaininvoiceitemsService {
  ...
  listProductBuyDiscardMainInvoiceItems(DiscardID: number): Observable<ResultProductBuyDiscardSelectMainInvoicesItems> {
    ...
    return this.http.get<ResultProductBuyDiscardSelectMainInvoicesItems>(this.listproductbuydiscardmaininvoiceitemsapiurl, httpOptions
    ).pipe(
      catchError(this.handleError<ResultProductBuyDiscardSelectMainInvoicesItems>('ListproductbuydiscardmaininvoiceitemsService'))
    );
  }
