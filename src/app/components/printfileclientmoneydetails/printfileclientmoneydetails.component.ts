...
import { AddCustomerRebateActionModel, CustomerTotalCommunicationSummaryModel, ResultCustomerMoneyDetails, AddCustomerModel, ResultListCustomers } from 'src/app/models/customers';
...
export class PrintfileclientmoneydetailsComponent implements OnInit {
  ...
  public getAllSupplierMoneyDetails() {
    ...
    this._listcustomermoneydetailsService
      ...
      .subscribe((_result: ResultCustomerMoneyDetails) => {
        ...
        this.allSupplierMoneyDetails = _result.CustomerMoneyDetailsList;
