...
import { ResultProductSaleDiscardSelectMainInvoices, ProductSaleDiscardSelectMainInvoices } from 'src/app/models/productsales';
...
export class OldsalebackwithoutbillComponent implements OnInit {
  ...
  public getAllProductSaleDiscardNotMainInvoices() {
