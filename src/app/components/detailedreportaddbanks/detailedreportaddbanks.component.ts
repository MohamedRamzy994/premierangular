import { ListSelectAdditionalCostEventToReport, ListSupplierProductsInStoreModel } from './../../models/reports';
...
export class DetailedreportaddbanksComponent implements OnInit {
  ...
  constructor(
   ...
   private _listadditionalcosteventtoreportService: ListadditionalcosteventtoreportService
   ...
   */
  public AdditionalCostEventToReport() {
    this._listadditionalcosteventtoreportService.AdditionalCostEventToReport()
    .subscribe((_result: ResultListAdditionalCostEventToReport) => {
      if (_result.ListSelectAdditionalCostEventToReport.length == 0 || _result.ListSelectAdditionalCostEventToReport == null) {

        this.listSelectAdditionalCostEventToReport = [];

      } else {
        this.listSelectAdditionalCostEventToReport = _result.ListSelectAdditionalCostEventToReport;
      }
