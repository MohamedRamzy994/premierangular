...
export class DetailedreportwithdrawdepositsComponent implements OnInit {
  ...
  constructor(
   ...
   private _listwithdrawdepositeventtoreportService: ListwithdrawdepositeventtoreportService
  ...
  public WithdrawDepositEventToReport() {
    ...
    .subscribe((_result: ResultListAdditionalCostEventToReport) => {
      if (_result.ListSelectAdditionalCostEventToReport.length == 0) {
