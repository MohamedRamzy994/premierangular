...
import { ListSupplierMoneyDetailsModel,
   SupplierTotalCommunicationSummaryModel,
    ResultSupplierMoneyDetails, AddRebateActionModel, AddSupplierModel, ResultSuppliers } from 'src/app/models/suppliers';
...
export class PrintfilesuppliermoneydetailsComponent implements OnInit {
