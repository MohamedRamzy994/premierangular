...
import {
  ...
  ResultCustomerMainInvoicesSalesReportDelegates,
  ListProductSaleSelectMainInvoicesToReport
...
import { ListproductsaleselectmaininvoicestoreportService } from 'src/app/services/reports/listproductsaleselectmaininvoicestoreport.service';
import { ListemployeetotalcommunicationreportService } from 'src/app/services/reports/listemployeetotalcommunicationreport.service';
...
@Component({
  selector: 'app-salesreportdelegates',
  templateUrl: './salesreportdelegates.component.html',
  styleUrls: ['./salesreportdelegates.component.css']
})
export class SalesreportdelegatesComponent implements OnInit {
  public resultlist: Resultproductgroups;
  public result: Resultstores;
  public resultEmployees: ResultListEmployees;
  ...
  public AllProductSaleMainInvoices: ListProductSaleSelectMainInvoicesToReport[];
  ...
  constructor(
    private _listcustomersService: ListemployeesService,
    ...
    private _listproductsaleselectmaininvoicestoreportService: ListproductsaleselectmaininvoicestoreportService,
    private _listemployeetotalcommunicationreportService: ListemployeetotalcommunicationreportService,
    ...
    this.resultEmployees = new ResultListEmployees();
    this.groupID = 0;
    this.storeID = 0;
    this.employeeID = 0;
    this.storeName = '';
  ...
  public getAllProductSaleMainInvoices(_employeeID: number) {
    ...
    this._listproductsaleselectmaininvoicestoreportService.CustomerMainInvoicesSalesReportDelegates()
    .subscribe((_result: ResultCustomerMainInvoicesSalesReportDelegates) => {
      if (_result.ListProductSaleSelectMainInvoicesToReport === null) {
        ...
        if (_employeeID === 0) {
          this.AllProductSaleMainInvoices = _result.ListProductSaleSelectMainInvoicesToReport;
          this.AllProductSaleMainInvoices.forEach((element: ListProductSaleSelectMainInvoicesToReport) => {
          ...
          this._listcustomersService.ListEmployees().subscribe((_resultemp: ResultListEmployees) => {
            this.supplierName =
              _resultemp.EmployeesList.filter((value: ListEmployeesModel) => value.EmpID == _employeeID)[0].EmpName;
            this.AllProductSaleMainInvoices =
              _result.ListProductSaleSelectMainInvoicesToReport
                .filter((value: ListProductSaleSelectMainInvoicesToReport) => value.EmpID == this.employeeID);
  ...
  public getAllEmployees(): void {
    ...
    this._listcustomersService.ListEmployees().subscribe((_result: ResultListEmployees) => {

      if (_result.EmployeesList === null) {

        this.resultEmployees.EmployeesList = [];
      } else {
        this.resultEmployees.EmployeesList = _result.EmployeesList;
      }
  ...
  public ListProductTotalCommunicationReport(_supplierID: number): void {
    this._listemployeetotalcommunicationreportService.ListEmployeeTotalCommunicationReport(_supplierID)
