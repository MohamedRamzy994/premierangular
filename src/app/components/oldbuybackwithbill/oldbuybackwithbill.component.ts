...
import { ProductBuySelectMainInvoices, ResultProductBuySelectMainInvoices, 
  ResultProductBuyDiscardSelectMainInvoices, ProductBuyDiscardSelectMainInvoices } from 'src/app/models/productbuy';
...
export class OldbuybackwithbillComponent implements OnInit {
