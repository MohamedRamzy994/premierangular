...
import { ResultSystemCreateProfitLoseReport, SystemCreateProfitLoseReport } from 'src/app/models/reports';
...
export class ProfitlossreportComponent implements OnInit {
  public listGetStartBalanceModel: SystemCreateProfitLoseReport;
  ...
  constructor(
    private  _listsystemcreateprofitlosereportService: ListsystemcreateprofitlosereportService ,
   ...
   private _apiurlService: ApiurlService
    ...
    this.listGetStartBalanceModel = new SystemCreateProfitLoseReport ();
  ...
  public GetStartBalance(): void {
    ...
    .subscribe((_result: ResultSystemCreateProfitLoseReport) => {
      if (_result.SystemCreateProfitLoseReport.length === 0 || _result.SystemCreateProfitLoseReport == null) {
        this.listGetStartBalanceModel =  new SystemCreateProfitLoseReport ();
      } else {

        this.listGetStartBalanceModel = _result.SystemCreateProfitLoseReport[0];
      }
    });
  }
