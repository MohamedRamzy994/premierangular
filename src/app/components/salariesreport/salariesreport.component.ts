...
import { ResultListEmployees, ListEmployeesModel, ResultListAllEmployeeSalary, ListEmployeeSalaryModel } from '../../models/employees';
...
import { ListemployeeallsalaryService } from 'src/app/services/employees/listemployeeallsalary.service';
...
export class SalariesreportComponent implements OnInit {
  ...
  public GetAllEmployeeSalary(_employeeID: number) {
      ...
      .subscribe((_result: ResultListAllEmployeeSalary) => {
        ...
        if (_result.AllEmployeeSalaryList == null) {
          ...
          this._listcustomersService.ListEmployees().subscribe((_resultemp: ResultListEmployees) => {
            this.supplierName = _resultemp.EmployeesList.filter((value: ListEmployeesModel) => value.EmpID == _employeeID)[0].EmpName;
            });
        } else {
