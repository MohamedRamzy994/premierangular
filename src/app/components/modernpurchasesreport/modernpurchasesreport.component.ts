...
export class ModernpurchasesreportComponent implements OnInit {
        ...
        if (_result.ProductBuyInvoices === null) {
          ...
          if (this.supplierID === 0) {
            ...
            this._listsuppliersService.ListSuppliers().subscribe((_resultsupp: ResultSuppliers) => {
              ...
              this.supplierName = _resultsupp.SuppliersList.filter((value: SupplierModel) => value.SupplierID == _supplierID)[0].SupplierName;

              this.listProductMoveMentReportModel = _result.ProductBuyInvoices.filter((value: ProductBuySelectMainInvoices) => value.SupplierName === this.supplierName);
